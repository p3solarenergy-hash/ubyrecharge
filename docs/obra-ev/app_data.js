(function () {
  ...
  const baseWorks = [
    ...
    { id: "posto-central-jk", nome: "Posto Central JK", status: "Concluida", pct: 100, kw: 60, crit: 0 },
  ...
  const baseObras = [
    ...
    { id: "posto-central-jk", nome: "Posto Central JK", cliente: "Posto Central JK", local: "Central JK", status: "Concluida", kind: "ok", pct: 100, kw: 60, carregadores: "1 x 60 kW", crit: 0, flags: ["Obra completa", "Base de recargas vinculada"], link: "gestao_obra_ev_detalhe.html?obra=posto-central-jk" },
